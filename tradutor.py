...
print('\033[0;35mComandos:')
print('codificar "\033[0;35ma palavra ou texto que deseja codificar\033[0;35m"')
print('decodificar "\033[0;35mo codigo binario que deseja decodificar"')
